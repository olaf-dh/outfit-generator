...
//    ];
     ...
     * @param SeasonType $season
     * @param WeatherConditionType|null $weather
     * @return array<string, ClothingItem[]>
     */
    private function loadCandidates(
        ...
        foreach ($zones as $zone) {
            /** @var array<ClothingItem> $zoneItems */
